...
var Data = (function () {
    ...
    const init = () => {
        ...
        const FRAGMENT_CLASSES_DATA = `fragment ClassesData on school { classes { id name feeAmount students { id, names, gender, parent { id, name, phone }, route { id, name } } teacher { id, name } } }`;
