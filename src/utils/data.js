...
var Data = (function () {
    ...
    const init = () => {
        ...
        const FRAGMENT_CLASSES_DATA = `fragment ClassesData on school { classes { id name feeAmount grade { id } students { id, names, gender, parent { id, name, phone }, route { id, name }, feeStatus { balance, balanceFormated } } teacher { id, name } } }`;
