...
var Data = (function () {
    ...
    const init = () => {
        ...
        const FRAGMENT_GRADES_OPTIONS_AND_IMAGES_DATA = `fragment GradesOptionsAndImagesData on school { id grades { id subjects { id topics { id subtopics { id questions { id videos images contentOrder attachments optionsOrder options { id value correct } }}}}}}}`;
